...
function searchYoutube(){
    ...
    .then(data => {
        ...
        videoDiv.innerHTML = `<iframe width="560" height="315" src="https://www.youtube.com/embed/${firstId}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>`
